function [route, dist,tiempo] = route_planner(dg, S, T)
...
%% INFORME .txt DEL ALGORITMO
    fileID=fopen('ACH.txt','At');
    fprintf(fileID,strcat('DESCRIPCION: algoritmo de Dijkstra\n'));
    fprintf(fileID,strcat('\ntiempo de resolucion: ',num2str(tiempo),'\n \n \n'));
    fclose(fileID);
